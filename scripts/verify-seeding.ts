...
import { User } from '../src/db/entities/core/User.entity';
import { Role } from '../src/db/entities/core/Role.entity';
import { Property } from '../src/db/entities/crm/Property.entity';
import { Contact } from '../src/db/entities/crm/Contact.entity';
import { Deal } from '../src/db/entities/crm/Deal.entity';
import { Agent } from '../src/db/entities/crm/Agent.entity';
import { Address } from '../src/db/entities/crm/Address.entity';
import { Office } from '../src/db/entities/crm/Office.entity';
import { Market } from '../src/db/entities/crm/Market.entity';
